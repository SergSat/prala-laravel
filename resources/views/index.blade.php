...
<div id="app" class="relative flex h-min">
    <div class="w-full lg:w-3/4 bg-blue-sky p-5">

        <!-- Header -->
        <header class="max-w-fit bg-white px-5 rounded-md drop-shadow-lg">
            <nav>
                <ul class="flex md:gap-3 xl:gap-7 py-4 text-xl">
                    <li><a href="#" class="active:underline active:text-blue-deep">Кабінет</a></li>
        ...
        <main>
            <article class="w-full pt-28 grid grid-cols-1 md:grid-cols-2 grid-flow-row gap-5">
                ...
                <section class="flex flex-col">
                    <h3 class="text-xl text-blue-deep pl-5 pt-5">Мої завдання</h3>
                    <div
                            class="max-w-xl min-w-16 mt-5 flex items-center justify-between bg-white rounded-md p-5 drop-shadow-lg">
                        <p
                                class="flex items-center before:mr-2 before:block before:content-[''] before:w-2.5 before:h-2.5 before:shrink-0 before:rounded-full before:bg-gray-soft">
                ...
                <section>
                    <div class="px-10 pb-10 bg-white text-center rounded-xl drop-shadow-lg">
                        <h3 class="text-xl text-blue-deep pt-5">Навчання</h3>
                        <div class="grid grid-rows-4">
                            <div class="relative bg-gray-soft mt-7 rounded-lg w-full h-24 flex text-center">
                ...
                <section class="max-w-xl pt-5">
                    <div class="px-6 flex justify-between">
                        <h3 class="text-xl text-blue-deep">Новини</h3>
                        <div class="group grid place-items-center gap-y-1">
                            <a href="#"
                               class="text-blue-deep group-hover:text-blueviolet transition-colors duration-300">
                                Читати все
                            </a>
                            <a href="#"
                    ...
                    <div class="bg-white mt-5 py-7 rounded-lg drop-shadow-lg">
                        <ul class="px-6">
                            <li>
                                <h4
                                        class="flex items-center before:mr-2 before:block before:content-[''] before:w-2 before:h-2 before:shrink-0 before:rounded-full before:bg-blue-deep">
                                    Заголовок новини 1
                                </h4>
                                <p class="text-brown-gray pt-3 pl-4">
                                ...
                                <hr class="h-px my-5 ml-5 bg-gray-sky border-0">
                            </li>
                            <li>
                                <h4
                                        class="flex items-center before:mr-2 before:block before:content-[''] before:w-2 before:h-2 before:shrink-0 before:rounded-full before:bg-blue-deep">
                            ...
                            <li>
                                <h4 class="flex items-center before:mr-2 before:block before:content-[''] before:w-2 before:h-2 before:shrink-0 before:rounded-full before:bg-blue-deep"">
                                Заголовок новини 1
                                </h4>
                                <p class=" text-brown-gray pt-3 pl-4">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum, numquam illum est
    ...
    <!-- Sidebar -->
    <aside
            class="lg:w-1/4 fixed inset-y-0 right-0 py-7 min-h-screen bg-beige flex flex-col items-center justify-between">
        <img src="{{ Vite::asset('resources/images/logo-prala.png') }}" alt="logo-prala">

        <section class="w-3/4 py-10 flex flex-col items-center border border-gray-sky rounded-lg">
