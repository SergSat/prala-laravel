...
<article class="
    ...
    <!-- Tasks -->
    <section class="mx-auto md:mx-0 flex flex-col">
    ...
    <section class="block">
        <div
            class="mx-auto mt-7 md:mx-0 px-10 pb-10 max-w-xl min-w-16 flex flex-col bg-white text-center rounded-xl drop-shadow-lg">
