		...
		<div
			...
			<div class="grid grid-cols-2 gap-5 mt-7 auto-rows-auto">
				...
				<div class="relative flex flex-col justify-center gap-3 group">
					<a href="#"
						class="block w-full rounded-lg h-28 bg-pr-gray-soft group-hover:ring-2 group-hover:ring-sky-400 group-focus:outline-none group-focus:ring group-focus:ring-indigo-300">
						<img src="{{ Vite::asset('resources/images/presentations-small.jpg') }}"
				...
				<div class="relative flex flex-col justify-center gap-3 group">
					<a href="#"
						class="block w-full rounded-lg h-28 bg-pr-gray-soft group-hover:ring-2 group-hover:ring-sky-400 group-focus:outline-none group-focus:ring group-focus:ring-indigo-300">
						<img src="{{ Vite::asset('resources/images/article-3_small.jpg') }}"
				...
				<div class="relative flex flex-col justify-center gap-3 group">
					<a href="#"
						class="block w-full rounded-lg h-28 bg-pr-gray-soft group-hover:ring-2 group-hover:ring-sky-400 group-focus:outline-none group-focus:ring group-focus:ring-indigo-300">
						<img src="{{ Vite::asset('resources/images/video-2-small.jpg') }}" alt="test with pencil"
							class="object-cover w-full h-full rounded-lg" />
					</a>
				...
				<div class="relative flex flex-col justify-center gap-3 group">
					<a href="#"
						class="block w-full rounded-lg h-28 bg-pr-gray-soft group-hover:ring-2 group-hover:ring-sky-400 group-focus:outline-none group-focus:ring group-focus:ring-indigo-300">
						<img src="{{ Vite::asset('resources/images/video-1-small.jpg') }}" alt="test with pencil"
							class="object-cover w-full h-full rounded-lg" />
					</a>
