<x-admin.dialog-modal wire:model.live="show">
    <x-slot name="title">
        {{ __('admin.' . ($id ? 'edit_qualification_category' : 'add_qualification_category') ) }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="mb-4">
            <x-admin.label for="profession" value="{!! __('admin.profession') !!}" />
            <select id="profession" wire:model="professionId" class="w-full" {{$parentId ? 'disabled' : ''}}>
                <option value="">--</option>
