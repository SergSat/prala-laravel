<x-authentication-layout>
    <div class="mx-auto flex h-dvh w-4/5 flex-col sm:max-w-[648px]">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div
                class="mb-5 mt-6 w-full rounded-2xl border border-white bg-white/15 px-6 pb-12 pt-6 backdrop-blur max-[380px]:px-5 max-[380px]:pb-10 max-[380px]:pt-6 min-[480px]:px-10 sm:mb-10 sm:px-12">
                <div class="flex flex-col items-center justify-between gap-10">
                    ...
                    <div
                        ...
                        <x-button
                            class="w-full px-2 py-1 text-xl tracking-wider text-center text-white transition-colors duration-200 justify-self-center font-extralight focus:border-b-2 focus:border-pr-blue/40 focus:outline-none focus:ring-0 group-hover:text-pr-blue/60 md:p-4 lg:text-3xl">
                            Зареєструватись
                        </x-button>
                    </div>
                    <x-validation-errors />
