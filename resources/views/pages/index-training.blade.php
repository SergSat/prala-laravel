...
@section('content')
	<article class="grid w-full grid-flow-row grid-cols-1 gap-5 lg:grid-cols-2 lg:pt-24">
		...
		<section class="mx-auto flex flex-col lg:mx-0">
			...
			<div
				class="mt-5 flex min-w-16 max-w-xl items-center justify-between rounded-md bg-white p-5 drop-shadow-lg">
				<p
					class="flex items-center text-balance text-sm before:mr-2 before:block before:h-2.5 before:w-2.5 before:shrink-0 before:rounded-full before:bg-pr-gray-soft before:content-[''] sm:text-base">
					Тест “Массажист Стоп Начальника”
				</p>
		...
		<section class="block">
			<div
				...
				<div class="flex items-center justify-between pt-5">
					...
					<a href="http://dev.prala-laravel.com/index" class="hover:text-pr-blueviolet">
						Назад
					</a>
				</div>
				<div class="mt-7 grid auto-rows-auto grid-cols-2 gap-5">
					<div class="group relative flex flex-col justify-center gap-3">
						<a
							...
							<img
								src="{{ Vite::asset('resources/images/tests_small.jpg') }}"
								alt="test with pencil"
								class="h-full w-full rounded-lg object-cover" />
						</a>
						<a
							href="http://dev.prala-laravel.com/tests"
							class="px-12 group-hover:text-pr-blueviolet">
							Тести
						</a>
					</div>
					...
					<div class="group relative flex flex-col justify-center gap-3">
						<a
							...
							class="block h-28 w-full rounded-lg bg-pr-gray-soft group-hover:ring-2 group-hover:ring-sky-400 group-focus:outline-none group-focus:ring group-focus:ring-indigo-300">
							<img
								src="{{ Vite::asset('resources/images/algorithms.jpg') }}"
								alt="types of algorithms"
								class="h-full w-full rounded-lg object-cover" />
						</a>
					...
					<div class="group relative flex flex-col justify-center gap-3">
						<a
							...
							class="block h-28 w-full rounded-lg bg-pr-gray-soft group-hover:ring-2 group-hover:ring-sky-400 group-focus:outline-none group-focus:ring group-focus:ring-indigo-300">
							<img
								src="{{ Vite::asset('resources/images/presentations_small.jpg') }}"
								alt="men doing presentation"
								class="h-full w-full rounded-lg object-cover" />
						</a>
					...
					<div class="group relative flex flex-col justify-center gap-3">
						<a
							...
							class="block h-28 w-full rounded-lg bg-pr-gray-soft group-hover:ring-2 group-hover:ring-sky-400 group-focus:outline-none group-focus:ring group-focus:ring-indigo-300">
							<img
								src="{{ Vite::asset('resources/images/article_3_small.jpg') }}"
								alt="hands writting an article"
								class="h-full w-full rounded-lg object-cover" />
						</a>
					...
					<div class="group relative flex flex-col justify-center gap-3">
						<a
							...
							class="block h-28 w-full rounded-lg bg-pr-gray-soft group-hover:ring-2 group-hover:ring-sky-400 group-focus:outline-none group-focus:ring group-focus:ring-indigo-300">
							<img
								src="{{ Vite::asset('resources/images/video_2_small.jpg') }}"
								alt="test with pencil"
								class="h-full w-full rounded-lg object-cover" />
						</a>
					...
					<div class="group relative flex flex-col justify-center gap-3">
						<a
							...
							class="block h-28 w-full rounded-lg bg-pr-gray-soft group-hover:ring-2 group-hover:ring-sky-400 group-focus:outline-none group-focus:ring group-focus:ring-indigo-300">
							<img
								src="{{ Vite::asset('resources/images/video_1_small.jpg') }}"
								alt="test with pencil"
								class="h-full w-full rounded-lg object-cover" />
						</a>
		...
		<section class="mx-auto max-w-xl pt-5 lg:mx-0">
			<div class="flex justify-between px-6">
				...
				<div class="group grid place-items-center gap-y-1">
					<a
						href="#"
						class="text-pr-blue transition-colors duration-300 group-hover:text-pr-blueviolet">
						Читати все
					</a>
					<a
						href="#"
						class="transition delay-150 duration-200 ease-in-out group-hover:translate-x-3">
						<svg
							width="56"
							height="12"
							viewBox="0 0 56 12"
