...
<body class="font-light min-h-screen flex items-center justify-center bg-no-repeat bg-cover bg-center bg-fixed"
	...
	<div class="h-full">
		<div class="mx-auto flex h-dvh w-4/5 flex-col sm:max-w-[648px]">
			...
			<hr class="max-[380px]:mt-6 mt-14 h-px border-0 bg-white" />
			<form action="">
				...
				<div
					class="mt-10 mb-5 sm:mb-10 w-full rounded-2xl border border-white bg-white/15 px-6 pb-12 pt-9 backdrop-blur max-[380px]:px-5 max-[380px]:pb-10 max-[380px]:pt-8 min-[480px]:px-12 sm:px-16 sm:pb-16">
