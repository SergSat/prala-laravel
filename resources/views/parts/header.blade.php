	...
	<section id="mobile-menu"
		...
		<nav>
			<ul class="mt-10 flex flex-col gap-5 text-2xl">
				...
				<li><a href="#" class="w-full text-center hover:opacity-60">Бібліотека</a>
				</li>
				<li><a href="#" class="w-full text-center hover:opacity-60">Налаштування</a>
				</li>
				<li><a href="#" class="w-full text-center hover:opacity-60">Голосування</a>
				</li>
				<li><a href="#" class="w-full text-center hover:opacity-60">Блог</a>
				</li>
				<li>
