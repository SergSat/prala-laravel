<div class="flex w-full rounded-lg">
    <div class="flex flex-col gap-2.5 @xs:flex-row @2xs:gap-5">
        ...
        <div class="flex flex-col gap-2.5 @xs:gap-5">
            <h4 class="self-start text-xl">
                Назва
            </h4>

            <a href="{{ route('vote-past') }}"
                class="group px-3 py-1 inline-flex items-center gap-2.5 font-light border border-pr-blue rounded-md text-pr-blue 
                transition-colors duration-200 hover:text-pr-blueviolet hover:border-pr-blueviolet hover:bg-pr-blue-sky/30 ">
                Переглянути
                <svg width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="transition duration-200 ease-in-out delay-150 group-hover:translate-x-1">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.9998 4.46528H0V3.96528H14.9998V4.46528Z"
                        fill="#0038FF"
                        class="transition-colors duration-200 group-hover:group-hover:fill-pr-blueviolet " />
