<div
    ...
    <div class="text-center">
        ...
        <p class="text-stone-500">Рід діяльності</p>
    </div>
    <div class="flex flex-col items-center text-center text-pr-gray-sky">
        <a href="tel:+00(000)000-00-00">+00(000)000-00-00</a>
