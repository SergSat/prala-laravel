...
<div>
    @foreach ($tasks as $task)
        <div class="{{$task->completed ? '--pr-success' : ''}} mt-5 flex min-w-16 max-w-xl items-center justify-between gap-4 rounded-md bg-white p-5 drop-shadow-lg max-[320px]:flex-col">
